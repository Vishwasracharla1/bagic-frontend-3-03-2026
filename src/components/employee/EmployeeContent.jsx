    ...
    return (
        <div>
            <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm font-medium tracking-wide">Personalized content recommendations based on your goals</p>
            </div>
                ...
                {employee.contentRecommendations.map((content) => (
                    <div key={content.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden group hover:border-primary-blue/30 transition-all duration-300">
                        <div className="bg-gray-50 p-4 border-b border-gray-100 flex items-center justify-between">
                            ...
                            <span className="bg-white text-gray-400 border border-gray-100 px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider">
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-[11px] text-gray-500 mb-4 leading-relaxed line-clamp-2 font-medium">{content.description}</p>
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                <div className="flex-1 flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] font-bold text-success uppercase tracking-tighter">{content.relevance}% Match</span>
                                </div>
                            </div>

                            <div className="flex flex-wrap gap-1.5 mb-4">
                                {content.topics.slice(0, 3).map((skill, i) => (
                                    <span key={i} className="bg-primary-blue/5 text-primary-blue text-[9px] px-2 py-0.5 rounded-md font-bold uppercase tracking-wider border border-primary-blue/5">
                                        {skill}
                                    </span>
                                ))}
                            </div>

                            <div className="flex items-center justify-between text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-4 border-t border-gray-50 pt-3">
                            ...
                            <div className="flex gap-2">
                                <button className="flex-1 bg-primary-blue text-white border-none py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider cursor-pointer hover:bg-primary-dark transition-all shadow-sm">
